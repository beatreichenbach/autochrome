...
from autochrome.utils.processing import Process, popen
...
class UpdateProcess(Process):
    def run(self) -> None:
        ...
        url = (
            'https://github.com/beatreichenbach/autochrome/archive/refs/heads/main.zip'
        )
        args = [executable, '-m', 'pip', 'install', '--upgrade', f'autochrome@{url}']
        self.popen(args)
